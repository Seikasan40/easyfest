    ...
    >
      ...
      <div className="mt-3 flex flex-col gap-2 sm:flex-row">
        <button
          ...
          className="rounded-xl bg-brand-coral px-4 py-2 text-sm font-medium text-white shadow-soft hover:opacity-90"
        >
          Tout accepter
        </button>
        <button
          ...
          className="rounded-xl border border-brand-ink/15 bg-white px-4 py-2 text-sm font-medium hover:bg-brand-ink/5"
        >
          Refuser l'analyse
        </button>
      </div>
